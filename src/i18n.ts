...
const englishMessages = {
    ...
    noSvnExecutableWarning: "SVN Graph could not find the `svn` executable on PATH.",
    ...
    openHistoryActionDescription: "Show commit history for this working copy",
    ...
    repositoryHistoryTooltip: "Repository path: {path}\nOpen SVN History",
    moreActionsTooltip: "More SVN Actions",
    branchKind: "branch",
    tagKind: "tag",
...
const messages: Record<SupportedLocale, MessageCatalog> = {
    ...
    "zh-CN": {
        ...
        repositoryHistoryTooltip: "仓库路径：{path}\n打开 SVN 历史",
        moreActionsTooltip: "更多 SVN 操作",
        branchKind: "分支",
        tagKind: "标签",
